        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-100 p-8 rounded-lg">
            ...
            <p className="text-gray-600 mb-4">
              For immediate inquiries, feel free to reach out via phone or email.
              For scheduling a consultation, please visit our{" "}
              <Link href="/schedule" className="text-blue-600 hover:text-blue-700 underline">
                Schedule page
              </Link>.
            </p>
            <div className="mt-6">
              <Link
                href="/schedule"
                className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition duration-300 w-full text-center"
              >
